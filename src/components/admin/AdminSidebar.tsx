...
import { Users, BarChart, Settings, LogOut, CreditCard, AlertTriangle, UserCheck } from "lucide-react"
        ...
        <ul className="space-y-2">
          <li>
            <button
              ...
              className={`w-full flex items-center p-3 rounded-md transition-colors ${
                activeTab === "associates" ? "bg-blue-800" : "hover:bg-blue-800/50"
              }`}
            >
          ...
          <li>
            <button
              ...
              className={`w-full flex items-center p-3 rounded-md transition-colors ${
                activeTab === "orphans" ? "bg-blue-800" : "hover:bg-blue-800/50"
              }`}
            >
              <AlertTriangle className="h-5 w-5 mr-3" />
              <span>Usuários Órfãos</span>
            </button>
          </li>
          <li>
            <button
