      ...
      <section className="relative bg-gradient-to-r from-blue-900 to-blue-700 text-white py-24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Associação de Reitores, Diretores, Professores, Estudantes de Nivel Superior e Funcionários de Instituições Educacionais</h1>
            <p className="text-xl md:text-2xl mb-8">com qualificações e experiencias comprovadas em sua área de atuação.</p>
